      ...
      <div className="mt-4 space-y-2">
        ...
        {discount && coupon ? (
          <div className="flex justify-between">
            <p className="me-4 text-sm text-body">{t('text-discount')}</p>
            <span className="me-auto flex items-center text-xs font-semibold text-red-500">
              ({coupon?.code})
              <button onClick={() => setCoupon(null)}>
                <CloseIcon className="ms-2 h-3 w-3" />
              </button>
            </span>
